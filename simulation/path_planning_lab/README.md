...
direction을 추가하는 R4/R5 v2는 명세만 승인돼 아직 구현하지 않았다. R4-3 validator는 builder를 import하지
...
[`ADR 0014`](../../docs/decisions/0014-section-bound-bounded-reverse-translation.md)에 두었고 구현은
아직 시작하지 않았다. hidden은 사용하지 않았다.
먼저 R4
