...
R4 상세 계약과 R4-1 immutable reference·revision 수명주기, R4-2 R3 source 변환 및 R4-3
독립 검증 구현은
...
[`local_reference_validation.py`](src/hospital_path_lab/local_reference_validation.py), 시험은
...
[`test_local_reference_validation.py`](tests/test_local_reference_validation.py)에 있다.
...
window manager, public runner와 R5 연결은 미구현이다. R4-3 validator는 builder를 import하지
